...
public class HomePage extends JFrame{
    private JButton btnOrders = new JButton();
    private JButton suppliersButton  = new JButton();
    private JButton allocateJobsButton  = new JButton();
    private JButton inventoryButton  = new JButton();
    private JButton notifyCustomersButton  = new JButton();
    private JButton employeesButton  = new JButton();
    private JButton notifyEmployeesButton  = new JButton();
